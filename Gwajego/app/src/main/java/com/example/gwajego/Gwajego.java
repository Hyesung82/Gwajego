package com.example.gwajego;

import android.os.AsyncTask;
import android.util.Log;

import com.example.gwajego.SSLConnect;
...
public class Gwajego {

    String htmlPageUrl = "http://lms.pknu.ac.kr/ilos/main/main_form.acl";
    String loginPageUrl = "http://lms.pknu.ac.kr/ilos/main/member/login_form.acl";
